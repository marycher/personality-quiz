  ...
  try {
    ...
    if (items.length === 0) {
      ...
      return [
		...
		{
          id: "6",
          text: "Что из этого Алина точно захочет привезти из-за границы или получить в подарок?",
          options: [
            { text: "Странные украшения", isCorrect: true },
            { text: "Магнит на холодильник", isCorrect: false },
            { text: "Местную посуду", isCorrect: true },
            { text: "Антикварный подсвечник", isCorrect: true },
          ],
        },
		{
          id: "7",
          text: "Сколько Алина жила заграницей?",
          options: [
            { text: "Не жила, только отпуск", isCorrect: false },
            { text: "2 месяца", isCorrect: false },
            { text: "Почти год", isCorrect: false },
            { text: "Больше 5 лет", isCorrect: true },
          ],
        },
		{
          id: "8",
          text: "Кем хотела стать Алина?",
          options: [
            { text: "Тестировщик пляжей", isCorrect: false },
            { text: "Смотритель панд", isCorrect: false },
            { text: "Технолог винного производства", isCorrect: true },
            { text: "Дегустатор сыров", isCorrect: false },
          ],
        },
		{
          id: "9",
          text: "В какой стране могла бы сейчас жить Алина, если бы судьба повернулась иначе?",
          options: [
            { text: "Австралия", isCorrect: true },
            { text: "Германия", isCorrect: false },
            { text: "США", isCorrect: false },
            { text: "Словакия", isCorrect: false },
          ],
        },
		{
          id: "10",
          text: "И финалочка, но самая сложная, как имя преподавателя на экзамене: ты сейчас едешь на ее др, а ты знаешь, сколько ей исполняется лет?",
          options: [
